...
async function startServer() {
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    app.get("/de", (req, res) => res.sendFile(path.join(distPath, "de/index.html")));
    app.get("/es", (req, res) => res.sendFile(path.join(distPath, "es/index.html")));
    app.get("/fr", (req, res) => res.sendFile(path.join(distPath, "fr/index.html")));
    app.get("/tools/resize-image-to-10kb", (req, res) => res.sendFile(path.join(distPath, "tools/resize-image-to-kb/10kb.html")));
    app.get("/tools/resize-image-to-20kb", (req, res) => res.sendFile(path.join(distPath, "tools/resize-image-to-kb/20kb.html")));
    app.get("/tools/resize-image-to-50kb", (req, res) => res.sendFile(path.join(distPath, "tools/resize-image-to-kb/50kb.html")));
    app.get("/tools/resize-image-to-100kb", (req, res) => res.sendFile(path.join(distPath, "tools/resize-image-to-kb/100kb.html")));
    ...
    app.get("/heic-to-jpg", (req, res) => res.sendFile(path.join(distPath, "heic-to-jpg/index.html")));
